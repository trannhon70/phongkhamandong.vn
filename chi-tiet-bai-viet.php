...
<body>
    ...
    <main>
        <article>
                ...
                <div class="article__container">
                    <div class="article__container-left">
                        <div class="article__container-left-div">
                            ...
                            <div id="form-tuvan" class="article__container-form">
                                <div class="article__container-form-title">
                                    ĐĂNG KÝ NHẬN TƯ VẤN
                                </div>
                                <div class="article__container-form-text">
                                    Vui lòng để lại thông tin và nhu cầu của
                                    Quý khách để được nhận tư vấn
                                </div>
                                <div class="article__container-form-input">
                                    <input name="hoten" type="text" placeholder="Họ và tên (*)">
                                </div>
                                <div class="article__container-form-input">
                                    <input name="ngaysinh" type="number" placeholder="Năm sinh">
                                </div>
                                <div class="article__container-form-input">
                                    <input name="sdt" type="number" placeholder="Số điện thoại (*)">
                                </div>
                                <div class="article__container-form-input">
                                    <textarea name="trieuchung" style="height: 80px;" type="text" placeholder="Mô tả triệu chứng"></textarea>
                                </div>
                                <div class="article__container-form-button">
                                    <button name="submit-DangKyngay" type="button">Đăng Ký Ngay</button>
                                </div>
                            </div>
                        </div>
            ...
            <?php include_once 'layout/contactLayout.php' ?>
        </article>
    </main>
...
<script>
            ...
            document.querySelector('button[name="submit-DangKyngay"]').addEventListener('click', function(event) {
                event.preventDefault();
                const form = document.getElementById('form-tuvan');
                const inputs = form.getElementsByTagName('input');
                const trieuchung =document.querySelector('textarea[name="trieuchung"]').value;
                const formData = {};
                ...
                formData['trieuchung'] = trieuchung;
                ...
                if (formData.hoten !== '' && formData.sdt !== '') {
                    ...
                    if (formData.ngaysinh && formData.ngaysinh.length > 4) {
                        return toastr.error("Năm sinh không được vượt quá 4 ký tự!");
                    }
                    if (formData.trieuchung && formData.trieuchung.length > 500) {
                        return toastr.error("Triệu chứng không được vượt quá 500 ký tự!");
                    }
                    if (formatPhoneNumber(formData.sdt)) {
                        var xhr = new XMLHttpRequest();
                        xhr.open("POST", "<?php echo $local ?>/api/khach-hang/create-form-tu-van.php", true);
                    ...
                    toastr.error("Họ tên và số điện thoại không được bỏ trống!");
                }
