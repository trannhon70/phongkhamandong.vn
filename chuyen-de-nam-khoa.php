        ...
        <section class="service">
            <div class="service__body">
                <div class="service__body-item">
                    <img loading="lazy" src="<?php echo $local ?>/images/icons/icon_bs1.webp" alt="...">
                </div>
                <div class="service__body-item">
                    <div class="service__body-item-card">
                        <img width="44px" height="44px" loading="lazy" src="<?php echo $local ?>/images/icons/icon_check1.webp" alt="...">
                        <div>
