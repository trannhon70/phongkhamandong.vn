    ...
    <session class="expert">
        ...
        <section class="treatment">
            <?php foreach ($slides as $slide): ?>
                <div class="list_image_card">
                    <img loading="lazy" height="100%" width="100%" src="<?php echo $local . $slide['image']; ?>"
        ...
        <section class="contact">
            ...
            <div class="contact__body">
                ...
                <div>
                    <strong>ĐỊA CHỈ: </strong> <span>Số 360 đường An Dương Vương, Phường Chợ Quán, TP Hồ Chí Minh, Việt
                        Nam</span>
                </div>
            </div>
        </section>
