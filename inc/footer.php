...
<footer id="footer__mobile" class="footer__mobile">
    <div class="footer__mobile-top">
        <div class="footer__mobile-top-body">
    ...
    <!-- <div class="footer__mobile-position" >
        <div class="footer__mobile-position-div" >
            <a class="footer__mobile-position-div-left" href="<?php echo $local ?>"></a>
            <a class="footer__mobile-position-div-center" href="tel:0968063109"></a>
            <a class="footer__mobile-position-div-right" href="<?php echo $local ?>"></a>
        </div>
    </div> -->
</footer>
