...
// $DSBenh = [
//     ['slug' => 'ngoai-khoa', 'name' => 'Ngoại Khoa'],
//     ['slug' => 'da-lieu', 'name' => 'Da Liễu'],
//     ['slug' => 'xet-nghiem', 'name' => 'Xét Nghiệm'],
//     ['slug' => 'chuan-doan-hinh-anh', 'name' => 'Chuẩn Đoán Hình Ảnh'],
// ];
?>
...
<header class="header" id="header_pc">
    ...
    <div class="header__bottom">
        ...
        <ul class="header__bottom-ul">
            ...
            <li class="header__bottom-ul-li">
                <a  href="<?php echo $local ?>/doi-ngu-bac-si.php">
                    <div>
                        <amp-img class="header__bottom-logo-img" src="<?php echo $local ?>/images/icons/icon-doingu.webp" height="50px" width="50px" alt="..."></amp-img>
                    </div>
            ...
            <li class="header__bottom-ul-li">
                <a  href="<?php echo $local ?>/danh-muc-ky-thuat.php">
                    <div>
                        <amp-img class="header__bottom-logo-img" src="<?php echo $local ?>/images/icons/icon-kythuat.webp" height="50px" width="50px" alt="..."></amp-img>
                    </div>

                    <div>DANH MỤC KỸ THUẬT</div>
                </a>
            </li>
            <li class="header__bottom-ul-li">
                <a  href="<?php echo $local ?>/bao-gia.php">
                    <div>
                        <amp-img class="header__bottom-logo-img" src="<?php echo $local ?>/images/icons/icon-baogia.webp" height="50px" width="50px" alt="..."></amp-img>
                    </div>
...
<header class="header__mobile" id="header_mobile">
    ...
    <div class="header__mobile-banner" >
        <img width="100%" src="<?php echo $local ?>/images/banner/bg_carousell0.webp" alt="...">
    </div>
    <nav  >
        <ul class="sidebar_mobile" >
            ...
            <li>
                <a href="<?php echo $local ?>/doi-ngu-bac-si.php">Đội Ngũ Bác Sĩ</a>
            </li>
            <li>
                <a href="<?php echo $local ?>/danh-muc-ky-thuat.php">Danh Mục Kỹ Thuật</a>
            </li>
            <li>
                <a href="<?php echo $local ?>/bao-gia.php">Báo Giá</a>
            </li>
            <li>
